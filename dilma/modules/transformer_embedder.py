...
@TokenEmbedder.register("transformer_embedder")
class TransformerEmbedder(TokenEmbedder):
    ...
    def get_transformer_output(self, token_ids, mask, type_ids=None, segment_concat_mask=None):
    ...
    def forward(
        ...
        transformer_output = self.get_transformer_output(token_ids, mask, type_ids, segment_concat_mask)
        embeddings = self.forward_on_transformer_output(
            transformer_output,
            fold_long_sequences,
            segment_concat_mask,
            batch_size,
    ...
    def forward_on_transformer_output(
            self,
            transformer_output,
            fold_long_sequences,
            segment_concat_mask=None,
            batch_size=None,
            num_segment_concat_wordpieces=None
    ):
