...
def main():
    ...
    test_data = get_data(
        f"datasets/{data_args.task_name}/data/{'validation' if data_args.task_name != 'news' else 'test'}.txt")
    ...
    config = AutoConfig.from_pretrained(
        model_args.config_name, num_labels=len(sorted(set(train_dataset.labels))))
