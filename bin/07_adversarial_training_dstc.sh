...
declare -A number_of_samples=(
  ['pwws']="100 500 1000 2500 5000 7500 8400"
  ['deepwordbug']="1000 2500 5000 75000 8800"
  ['hotflip']="100 500 1000 2000 3315"
  ['textbugger']="100 500 1000 2000 3000 5000 6000"
)

# for dataset in "rotten_tomatoes" "sst2" "dstc" "ag_news" "qqp"; do
for dataset in "dstc"; do
    ...
    for attacker in "deepwordbug" "textbugger" "pwws" "hotflip"; do
        ...
        declare -a current_list_of_numbers=(${number_of_samples[${attacker}]})
        
        for num_examples in ${current_list_of_numbers[@]}; do
...
PYTHONPATH=. python scripts/parse_adv_training_metrics.py